...
- `doc/使用手册.md`：使用手册索引页，指向入门篇和进阶篇。
- `doc/使用手册-入门篇.md`：面向新手的入门手册（安装、用例、执行、报告）。
- `doc/使用手册-进阶篇.md`：进阶功能手册（数据驱动、并发、协议扩展、平台）。
...
| `doc/使用手册-入门篇.md` | CLI 用法、用例格式、基础示例变化时 |
| `doc/使用手册-进阶篇.md` | 高级功能、协议扩展、平台使用变化时 |
